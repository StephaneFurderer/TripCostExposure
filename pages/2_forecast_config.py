...
def create_traveling_forecast_by_cohort(purchase_forecast, trip_cost_forecast, traveling_patterns, selected_segment=None):
    ...
    purchase_forecast = purchase_forecast.merge(trip_cost_forecast[['purchase_week','iso_week', 'avg_trip_cost']], left_on='week_purchased', right_on='purchase_week', how='left')   
